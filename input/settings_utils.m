classdef settings_utils
    ...
    properties (Constant) %Constant
        ...
        %% bv or bv+cell
        model = settings_utils.run_model;
        
        %% geometry
        discretize = false;
        mesh_type = settings_utils.get_mesh_type; % used when discretize = true       
        
        %% static flow calculation
        userdefined_qin = false; % flow input
        pbc = settings_utils.pbc_set; % pressure and flow bc
        
        %% dynamic parameters
        
        % # species
        NVs = settings_utils.get_NVspecies;
        Vspecies = settings_utils.get_Vspecies;
        NCs = settings_utils.get_NCspecies;
        Cspecies = settings_utils.get_Cspecies;
        
        %parameters
        diffusivity = settings_utils.get_diffusivity;
       
       
        Vinf = settings_utils.get_Vinf;
        rxn_set = settings_utils.get_rxn_set.degree_2;
        rxn_vol = settings_utils.get_rxn_vol_set.equal;
        
        pressure_scan = settings_utils.get_pressure_scan;
